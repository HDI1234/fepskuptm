...
<div class="container">
     ...
     <center><h1>KUPTM FEPS</h1></center> 
   ...
   <br> 
    ...
    <thead>
      <tr>
        ...
        <th><a href="<?php echo base_url('home/searchOrderByCourse'); ?>">Question Code</th>
        <th><a href="<?php echo base_url('home/searchOrderByFaculty'); ?>">Question dept</th>
